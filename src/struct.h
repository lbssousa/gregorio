...
typedef struct gregorio_lyric_line {
    /* the text of this level, a gregorio_character list like syllable->text */
    struct gregorio_character *text;
    /* the next (lower) lyric line of the same syllable */
    struct gregorio_lyric_line *next;
    /* word position of this level, independent from the level-1 position */
