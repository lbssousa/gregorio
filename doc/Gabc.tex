...
\begin{description}
  \item[above lines text] Text between \texttt{<alt>} and \texttt{</alt>} is
    ...
    \texttt{left}, \texttt{center}, or \texttt{right}).  \texttt{<alt-l>}\dots
    \texttt{</alt-l>}, \texttt{<alt-c>}\dots\texttt{</alt-c>}, or
    \texttt{<alt-r>}\dots\texttt{</alt-r>} may be used instead of
    \texttt{<alt>}\dots\texttt{</alt>} to force left, center, or right
    alignment for that occurrence, regardless of the document default.  Note
    that when the
...
\verb=\gresetabovelinestextalignment=); use \texttt{[alt-l:}\textit{text}%
\texttt{]}, \texttt{[alt-c:}\textit{text}\texttt{]}, or
\texttt{[alt-r:}\textit{text}\texttt{]} instead of \texttt{[alt:}\textit{text}%
\texttt{]} to force left, center, or right alignment for that occurrence,
