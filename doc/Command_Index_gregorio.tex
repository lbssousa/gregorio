...
Macro to end elements.  When \verb=\ifgre@nabc@interglyphpadding= is true, calls \verb=\gre@nabc@reduce@rightbalance= with the inter-element spacing that was just emitted.
...
Macro to end a glyph without ending the element.  When \verb=\ifgre@nabc@interglyphpadding= is true, calls \verb=\gre@nabc@reduce@rightbalance= with the inter-glyph spacing that was just emitted (but does not emit a kern, since sub-glyphs within the same element are naturally covered by the element's NABC annotation).
...
\verb=\ifgre@nabc@interglyphpadding= is true, \verb=\gre@nabc@prepare= sets
\verb=\gre@dimen@nabc@rightbalance@i= via its third argument.
...
\verb=\ifgre@nabc@interglyphpadding= is true, \verb=\gre@nabc@prepare= sets
\verb=\gre@dimen@nabc@rightbalance@ii= via its third argument.
...
pre-phase has run.  When \verb=\ifgre@nabc@interglyphpadding= is true,
\verb=\gre@nabc@prepare= sets \verb=\gre@dimen@nabc@rightbalance@i= via its
third argument.
