...
% the vertical separation between two stacked lyric lines
\gre@createdim{dimen}{lyricstackseparation}{0.5 cm}{scalable}%
...
% same idea, but for the below-lines nabc line. Defaults to the same value
% as the lyrics threshold above, since blnabc sits right next to them and
% should react to low notes at the same point they do.
