  ...
  \ifgre@nabc@interglyphpadding%
    \ifdim\gre@dimen@nabc@prevbalance>0pt\relax%
      ...
      \ifdim\gre@dimen@nabc@prevbalance@ii>0pt\relax%
        ...
        \fi%
      \fi%
      % Update combined rightbalance = MAX(@i, @ii) after any restores.
...
\def\GreGlyph#1#2#3#4#5#6#7{%
  ...
  \fi
  % Reduce NABC right-balance by the glyph width (horizontal advance).
  \ifgre@nabc@interglyphpadding%
    \global\advance\gre@dimen@nabc@rightbalance by -\gre@dimen@lastglyphwidth\relax%
    \global\advance\gre@dimen@nabc@rightbalance@i by -\gre@dimen@lastglyphwidth\relax%
    \global\advance\gre@dimen@nabc@rightbalance@ii by -\gre@dimen@lastglyphwidth\relax%
  \fi%
...
\def\gre@syllablenotes#1{%
  ...
  \global\gre@firstglyphtrue%
  % Reset rightbalance after boxing so the real pass starts clean.
  \global\gre@dimen@nabc@rightbalance=0pt\relax %
  \global\gre@dimen@nabc@rightbalance@i=0pt\relax %
  \global\gre@dimen@nabc@rightbalance@ii=0pt\relax %
