...
\def\gre@nabc@prepare#1#2{%
  ...
  \fi%
  % Update inter-glyph right-balance: keep the maximum NABC width across
  % all voices for this glyph so the next glyph can check whether extra
  % padding is needed.
  \ifgre@nabc@interglyphpadding%
    \ifdim\wd\gre@box@nabctemp>\gre@dimen@nabc@rightbalance\relax%
      \global\gre@dimen@nabc@rightbalance=\wd\gre@box@nabctemp\relax%
    \fi%
  \fi%
...
\def\GreSetNabcAboveLines#1{%
  \gdef\gre@nabc@pre@voice@i{%
    ...
    \ifgre@nabc@interglyphpadding%
      \global\gre@dimen@nabc@rightbalance@i=\wd\gre@box@nabc@voice@i\relax%
    \fi%
    \gdef\gre@nabc@pre@voice@i{}%
  }%
...
\def\GreSetNabcBelowLines#1{%
  \gdef\gre@nabc@pre@voice@ii{%
    ...
    \ifgre@nabc@interglyphpadding%
      \global\gre@dimen@nabc@rightbalance@ii=\wd\gre@box@nabc@voice@ii\relax%
    \fi%
    \gdef\gre@nabc@pre@voice@ii{}%
  }%
...
\def\GreEndOfElement#1#2#3{%
  ...
  \fi%
  % Reduce NABC right-balance by the inter-element space just emitted.
  \ifgre@nabc@interglyphpadding%
    \global\advance\gre@dimen@nabc@rightbalance by -\gre@skip@temp@four\relax%
    \global\advance\gre@dimen@nabc@rightbalance@i by -\gre@skip@temp@four\relax%
    \global\advance\gre@dimen@nabc@rightbalance@ii by -\gre@skip@temp@four\relax%
  \fi%
  \ifgre@unbreakableendofelement %
    \GreNoBreak %
  \fi %
...
\def\GreEndOfGlyph#1{%
  ...
  \gre@get@spaceskip{#1}%
  \gre@hskip\gre@skip@temp@four %
  % Reduce NABC right-balance by the inter-glyph space just emitted.
  \ifgre@nabc@interglyphpadding%
    \global\advance\gre@dimen@nabc@rightbalance by -\gre@skip@temp@four\relax%
    \global\advance\gre@dimen@nabc@rightbalance@i by -\gre@skip@temp@four\relax%
    \global\advance\gre@dimen@nabc@rightbalance@ii by -\gre@skip@temp@four\relax%
