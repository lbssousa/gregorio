...
\def\gre@alteration@visible#1#2#3#4#5#6{%
  ...
  \raise \gre@dimen@glyphraisevalue%
  \copy\gre@box@temp@width%
  % Reduce NABC right-balance by the alteration width (horizontal advance).
  \ifgre@nabc@interglyphpadding%
    \global\advance\gre@dimen@nabc@rightbalance by -\wd\gre@box@temp@width\relax%
    \global\advance\gre@dimen@nabc@rightbalance@i by -\wd\gre@box@temp@width\relax%
    \global\advance\gre@dimen@nabc@rightbalance@ii by -\wd\gre@box@temp@width\relax%
  \fi%
  \ifgre@notes@invisrender
    \phantom{#5}\relax %
  \else
  ...
  \ifnum#3=0\relax %
    ...
    \else %
      \gre@hskip\gre@skip@temp@four %
    \fi %
    % Reduce NABC right-balance by the alteration space just emitted.
    \ifgre@nabc@interglyphpadding%
